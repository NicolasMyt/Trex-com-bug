...
function preload(){
  ...
  trex_crouch = loadAnimation("trexagaichando.png","trexagaichando2.png");
  
  groundImage = loadImage("ground2.png");
  
  cloudImage = loadImage("cloud.png");

  AveImage = loadAnimation("Ave1.png","Ave2.png");
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //fazer o trex agaichar
    if(keyDown(DOWN_ARROW)) {
      trex.addAnimation("agaichando",trex_crouch);
      trex.changeAnimation("agaichando",trex_crouch);
  }
...
function spawnAve(){
  Ave = createSprite(600,135);
  Ave.addAnimation("Voando",AveImage);
  Ave.velocityX = -3;
  Ave.scale = 0.5;
}
